(() => {
  ...
  function ensureModal(){
    ...
    modal.innerHTML=`<div class="team-esports-backdrop" data-close-profile></div><article class="team-esports-profile" role="dialog" aria-modal="true" aria-labelledby="teamProfileName"><div id="teamProfileContent"></div></article>`;
