...
html[data-theme="light"] .tl-member-preview{background:#111612;color:#f2f6f3;border-color:#39ddea;box-shadow:0 18px 44px rgba(0,0,0,.34)}html[data-theme="light"] .tl-member-preview h3{color:#5ef3ff}html[data-theme="light"] .tl-member-preview-meta,html[data-theme="light"] .tl-member-preview-game{color:#c5cec7}html[data-theme="light"] .tl-member-preview-role{color:#fff;background:#092329;border-color:#5ef3ff}html[data-theme="light"] .tl-member-preview-go{background:#102013;color:#73ff18;border-color:#73ff18}
